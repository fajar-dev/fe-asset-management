...
function getRowItems(row: Row<any>) {
  return [
    { type: 'label', label: t('page.note.actions') },
    {
      label: t('page.note.edit'),
...
const columns = computed<TableColumn<any>[]>(() => [
  { accessorKey: 'occuredAt', header: t('page.note.date') },
  { accessorKey: 'note', header: t('page.note.note') },
  {
    id: 'actions',
    cell: ({ row }) => {
    ...
    <template #body>
      ...
      <RoleWrapper role="admin">
        <ConfirmModal
          ...
          :title="t('page.note.deleteTitle')"
          :description="t('page.note.deleteDescription')"
